...
function temperatureAt(base: number, y: number): number {
...
function snowsAt(dimension: Dimension, location: Vector3): boolean {
...
function openToSky(block: Block): boolean {
...
export function isSnowingOn(block: Block): boolean {
...
export function addLayer(block: Block): void {
