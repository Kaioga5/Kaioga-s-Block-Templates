...
// falls in Bedrock, and custom blocks have no native gravity at 1.26.50, so
...
// (behavior_pack/biomes/*.biome.json in the 1.26.50 samples). Biomes at 0.5
...
export const biomeTemperatures = new Map([
