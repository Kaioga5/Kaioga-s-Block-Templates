...
import { BlockComponentRandomTickEvent, MolangVariableMap, system } from "@minecraft/server";
...
let colour: MolangVariableMap | undefined;
...
function leafColour(): MolangVariableMap {
    if (colour === undefined) {
