...
// bone_visibility
export const SIDE_STATES = ["kai_templates:north", "kai_templates:south", "kai_templates:east", "kai_templates:west"] as const;
...
export const clingingIds = new Set<string>([
...
export const nonClingingIds = new Set<string>([
