...
import { GROWTH_CHANCE, SIDE_STATES, SPREAD_HEIGHT, SPREAD_LIMIT, SPREAD_RADIUS, VINES_ID, } from "./config.js";
import { SIDE_OFFSETS, anySide, applyFlags, canCling, placeVine, readFlag, sameFlags, supportedFlags, } from "./attachment.js";
...
const DIRECTIONS = ["up", "down", ...SIDE_STATES];
function coinFlip() {
...
function growSideways(block, flags, side) {
    if (crowded(block)) {
        return;
    }
