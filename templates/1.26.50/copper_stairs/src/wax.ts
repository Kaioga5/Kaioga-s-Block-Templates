// Handles copper maintenance on the stairs: honeycomb waxes them while
...
// copper door and trapdoor use, so all the copper templates share one
// precise item-use path instead of a generic interact handler.
import {
  Block,
...
import { STAGE_BY_ID, STAGE_BY_WAXED_ID, swapStairsType } from "./family.js";
...
world.beforeEvents.playerInteractWithBlock.subscribe((event) => {
  ...
  // Honeycomb waxes unwaxed stairs, but only while sneaking, the
  // deliberate crouch keeps waxing deliberate, like the other copper
  // templates
