...
import { Block, EntityEquippableComponent, EquipmentSlot, GameMode, ItemStack, Player, system, world } from "@minecraft/server";
import { MYCELIUM_ID, ToolConversion, toolConversions } from "./config.js";

// Take one point of durability off the tool, the way vanilla does. Creative
// players keep theirs untouched
function damageTool(player: Player, equipment: EntityEquippableComponent, tool: ItemStack): void {
...
function convert(block: Block, conversion: ToolConversion, player: Player): void {
...
function conversionFor(held: ItemStack): ToolConversion | undefined {
