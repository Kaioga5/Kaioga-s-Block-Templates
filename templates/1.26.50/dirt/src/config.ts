...
// rows, not extra code
export const grassSpreadTargets = new Map<string, string>([
...
// dirt too
export const grassSources = new Set<string>([
...
// What bone meal can grow on top of this dirt. Weights are relative, a
