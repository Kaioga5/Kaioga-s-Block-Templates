...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:trapdoor_redstone", {
        ...
        onRedstoneUpdate(event) {
            ...
            block.dimension.playSound(powered ? "open.wooden_trapdoor" : "close.wooden_trapdoor", block.center());
        },
    });
});
