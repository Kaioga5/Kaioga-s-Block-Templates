...
import { FARMLAND_ID, GROWTH_STATE, MAX_GROWTH, MIN_LIGHT, MOISTURE_STATE, POINTS_DRY, POINTS_DRY_NEIGHBOUR, POINTS_WET, POINTS_WET_NEIGHBOUR, WHEAT_ID, } from "./config.js";
...
export function advance(block, stages) {
    ...
    block.setPermutation(BlockPermutation.resolve(WHEAT_ID, { ...states, [GROWTH_STATE]: next }));
}
