...
import { CACTUS_ID, CONTACT_DAMAGE, CONTACT_INTERVAL, CONTACT_PLAYER_RANGE, ENTITY_HEIGHT, ENTITY_RADIUS, } from "./config.js";
...
function touches(entity, cactus) {
    ...
    return (at.x + ENTITY_RADIUS > minX &&
