// Handles copper maintenance on the slab: honeycomb waxes it while
...
import { STAGE_BY_ID, STAGE_BY_WAXED_ID, swapSlabType } from "./family.js";
...
world.beforeEvents.playerInteractWithBlock.subscribe((event) => {
  ...
  // Honeycomb waxes an unwaxed slab, but only while sneaking, the
