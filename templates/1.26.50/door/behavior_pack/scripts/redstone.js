...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:door_redstone", {
        ...
        onRedstoneUpdate(event) {
            ...
            dimension.playSound(powered ? "open.wooden_door" : "close.wooden_door", block.center());
        },
    });
});
