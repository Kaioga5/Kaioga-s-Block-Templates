import { CHAIN_FUSES, FUSE_PROPERTY, FUSE_SECONDS, FUSE_SOUND, LAUNCH_DRIFT, LAUNCH_UP, PRIMED_ID, } from "./settings.js";
...
// full four seconds
export function primeAt(dimension, position, chained) {
...
export function primeBlock(block, chained) {
