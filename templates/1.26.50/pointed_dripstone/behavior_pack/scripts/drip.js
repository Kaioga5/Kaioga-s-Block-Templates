...
// something else
function fillCauldron(cauldron, liquid) {
    ...
    cauldron.setPermutation(BlockPermutation.resolve(CAULDRON_ID, {
        ...states,
...
function raiseStalagmite(landing) {
