...
function layersOf(states: Record<string, boolean | number | string>): number {
...
function melt(block: Block): void {
...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:snow_melt", {
        ...
        onPlayerBreak(event: BlockComponentPlayerBreakEvent): void {
            ...
            const silk =
                tool.getComponent("minecraft:enchantable")?.getEnchantment("silk_touch") !== undefined;
