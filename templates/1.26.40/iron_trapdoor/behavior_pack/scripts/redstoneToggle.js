...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:iron_trapdoor_redstone", {
        ...
        onRedstoneUpdate(event) {
            ...
            dimension.playSound(powered ? "open.iron_trapdoor" : "close.iron_trapdoor", block.center());
        },
    });
});
