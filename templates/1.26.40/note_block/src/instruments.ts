...
const SOUND_BY_BLOCK = new Map<string, string>();
...
export function instrumentFor(blockId: string | undefined): string {
  return (
    (blockId !== undefined ? SOUND_BY_BLOCK.get(blockId) : undefined) ??
    DEFAULT_INSTRUMENT
  );
}
