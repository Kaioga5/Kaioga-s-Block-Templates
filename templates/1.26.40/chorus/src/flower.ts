...
function becomeStem(flower: Block): void {
...
function isFreeSpace(block: Block | undefined, ignore: { x: number; y: number; z: number } | undefined): boolean {
