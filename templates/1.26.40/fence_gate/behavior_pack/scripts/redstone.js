...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:fence_gate_redstone", {
        ...
        onRedstoneUpdate(event) {
            ...
            dimension.playSound(powered ? "open.fence_gate" : "close.fence_gate", block.center());
        },
    });
});
