...
function addPickle(block, player) {
...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:sea_pickle_combine", {
        beforeOnPlayerPlace,
    });
    init.itemComponentRegistry.registerCustomComponent("kai_templates:sea_pickle_combine", {
        onUseOn,
    });
});
