...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:wooden_slab_combine", {
        beforeOnPlayerPlace,
        onPlayerBreak,
    });
    init.itemComponentRegistry.registerCustomComponent("kai_templates:wooden_slab_combine", {
        onUseOn,
    });
});
