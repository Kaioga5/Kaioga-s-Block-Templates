...
system.beforeEvents.startup.subscribe((init) => {
    init.blockComponentRegistry.registerCustomComponent("kai_templates:door_interact", {
        ...
        onPlayerInteract(event) {
            ...
            dimension.playSound(wasOpen ? "close.wooden_door" : "open.wooden_door", block.center());
        },
    });
});
