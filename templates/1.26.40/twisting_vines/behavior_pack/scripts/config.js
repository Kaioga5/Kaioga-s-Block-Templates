// How fast twisting vines climb, how far, and how they feel to climb.
export const VINE_ID = "kai_templates:twisting_vines";
export const AGE_STATE = "kai_templates:age";
export const TIP_STATE = "kai_templates:tip";
// Vanilla lets a twisting vine reach age 25 before it stops. A custom block
// state may hold at most 16 values, so this caps at 15 and the vine tops out
// a little shorter than a nether one
export const MAX_AGE = 15;
// Chance that a random tick on the tip adds one more segment. Vanilla rolls
// one in ten
export const GROWTH_CHANCE = 0.1;
// Ticks between one segment coming down and the next when a stalk is cut.
...
export const unsupportiveIds = new Set(["minecraft:barrier", "minecraft:light_block"]);
