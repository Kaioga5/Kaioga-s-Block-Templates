...
// One position waiting for a new distance
interface Pending {
    dimension: Dimension;
    location: Vector3;
}
...
function key(dimension: Dimension, location: Vector3): string {
...
function worldBounds(dimension: Dimension): { min: number; max: number } | undefined {
...
export function enqueue(dimension: Dimension, location: Vector3): void {
...
export function enqueueNeighbours(dimension: Dimension, location: Vector3): void {
...
export function isQueued(dimension: Dimension, location: Vector3): boolean {
...
function update(entry: Pending): void {
...
function affectsLeaves(permutation: BlockPermutation): boolean {
